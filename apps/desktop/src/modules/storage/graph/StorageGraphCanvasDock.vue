...
import { Hand, LayoutGrid, MousePointer2, StickyNote, Waypoints } from "lucide-vue-next";
...
<template>
  <TooltipProvider :delay-duration="120">
    <div class="pointer-events-auto absolute bottom-5 left-1/2 z-30 -translate-x-1/2">
      <div
        class="flex items-center gap-1 rounded-[26px] border border-border/25 bg-surface-0/92 p-1.5 shadow-[0_18px_70px_-28px_rgba(0,0,0,0.6)] backdrop-blur-xl"
      >
