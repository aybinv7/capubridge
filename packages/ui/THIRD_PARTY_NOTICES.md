...
Cladd is the reference for surface depth, sizing relationships, accent scoping, DOM structure, motion, and interaction behavior. `@capubridge/ui` is an independent Vue implementation and is not an official Cladd package.
