...
**v1.16.2** — active beta. Core session model, ADB management, CDP inspection, storage explorer, logcat, performance monitor, screen mirror, recording, and replay are functional. Experimental surfaces remain hidden until their complete workflows are ready.
